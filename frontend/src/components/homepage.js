...
export default class HomePage extends Component {
  ...
  render() {
    console.log('Inside HomePage component render');
    return (
        ...
        <Router>
            ...
            <Routes>
              ...
              <Route path="/create" element={<CreateRoomPage guestCanPause={false}/>} />
              <Route path="/room/:roomId" element={<Room leaveRoomCallback={this.clearRoomCode}/>} />
            </Routes>
